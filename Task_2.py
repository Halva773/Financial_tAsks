...
7. Ввести число с клавиатуры и найти его абсолютное значение (модуль), результат сохранить в MySQL.
8. Все результаты вывести на экран из MySQL.
9. Сохранить все данные из MySQL в Excel.
10. Вывести все данные на экран из Excel.\n""")
    while num != "quit":
        if num == "1":
            ...
            write_in_db("abs", input("Введите название таблицы, в которую хотите занести изменения: "),
                        input("Напишите число, абсолютное значение которого хотите получить. Например -3\n"))
        elif num == "8":
            for line in read_db():
                print(line)
        elif num == "9":
